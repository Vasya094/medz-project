		...
		<Head>
			...
			<meta name="keywords"
				  content="Прокат инструмента, Прокат инструмента Астрахань,
				   ...
				   Элиста, Волжский, Хасавюрт, Волгоград, Махачкала, Грозный,
				    Актау, Назрань, Камышин, Волгодонск, Владикавказ, Пятигорск,
				     Дербент, Нальчик, Ставрополь Прокат строительного инструмента,
