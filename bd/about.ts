export const aboutUsPage = {
    "pageBody": `<h1>Кто мы?</h1>
    <p>Наша компания предоставляет услуги аренды и проката строительной техники и инструментов, а также занимается продажей широкого <strong> ассортимента оборудования, включая бетономешалки, мини-тракторы </strong> и многое другое. Мы понимаем, насколько важна надежная техника на строительной площадке, поэтому предлагаем только проверенные и качественные модели для любых задач.
    </p> 
    ...
    "title": "Подробнее - Прокат строительной техники и инструмента",
...
export const siteInfo = {
    ...
    "siteName": "Прокат Инструмента Астрахань",
    "siteUrl": "https://ug-tool-rent.ru",
